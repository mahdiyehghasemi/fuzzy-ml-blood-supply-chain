...
d(h,b,t)=uniformint(150,200);

a(j,b,t)=uniformint(150,250);
...
oinv(k,i)=uniformint(20,35);

beta(t,b)=uniform(0.04,0.15);

otest(i,b,t)=uniformint(400,550);

gvup(v,t)=uniformint(20,25);

rinv(k,b)=uniform(300,350);
...
eqzt            ..      ztotal=e=((z1-63276)/63276)+((z2-496)/496)+5*((z3-4500)/4500);
