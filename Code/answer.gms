...
Sets
         ...
         h index of hospitals/h1,h2,h3,h4/

         b index of types of blood/b1,b2,b3/

         t index of time periods/t1,t2,t3/

         i index of candid nodes for blood banks/i1,i2,i3,i4,i5,i6/

         j index of donation centers/j1,j2,j3/

         k index of blood facilities/k1,k2,k3/
...
Parameters
         ...
         cinv(k) The cost of purchasing and setting up a unit of type ko storage equipment/k1 400,k2 500,k3 600/

         rinv(k,b) The maximum number of blood units of type b that can be stored in equipment ko

         chold(b) The cost of maintaining a unit of type b blood for a period in the blood bank/b1 4,b2 5,b3 6/

         o(v) Transport capacity of type v vehicle/v1 150,v2 100,v3 200/

         s(b) The number of units required to transport one unit of product type b/b1 3,b2 2,b3 4/

         d(h,b,t) The demand of treatment center ho in period t for type b blood
         ...
         l(i,h) The distance between blood bank i and treatment center ho

         cvar(v,b) The variable cost of transporting each unit of type b blood by means of type v per unit distance

         cfix(v) The fixed cost of transporting each unit of blood by vehicle type v/v1 80,v2 60,v3 70/

         oinv(k,i) Maximum storage equipment of type ko on type i blood bank
         ...
         gbup The upper limit of the number of blood banks that can be built/7/

         gblow The lower limit of the number of blood banks that can be built/1/

         maxe(h) upper limit of def dor each treat center
...
cbc(i)=uniformint(1000,2000);

d(h,b,t)=uniformint(50,100);

a(j,b,t)=uniformint(100,200);

ctest(i,b)=uniformint(5,8);

l(i,h)=uniformint(10,15);

cvar(v,b)=uniformint(5,10);

oinv(k,i)=uniformint(15,25);

beta(t,b)=uniform(0.02,0.10);

otest(i,b,t)=uniformint(150,250);

gvup(v,t)=uniformint(10,20);

rinv(k,b)=uniform(150,200);

cqveh(v)=uniformint(200,300);
...
eq366           ..      f6=e=sum((v,t),qveh(v,t)*cqveh(v));
...
eq323(i,b,t)    ..      qinvc(i,b,t)=e=qinvc(i,b,t-1)+alpha*qtest(i,b,t)-sum((h,v),qtrns(i,h,b,v,t))-wc(i,b,t);
...
eq330(i)        ..      sum((h,t,v),u(i,h,t,v))=l=x(i)*m;

eqzt            ..      ztotal=e=((z1-46827)/46827)+((z2-241)/241)+((z3-1306)/1306);


limext          ..      sum((h,b,t),e(h,b,t))=l=sum((h,b,t),d(h,b,t));

limbudg         ..      f1+f2+f3+f4+f5+f6=l=budg;
...
option limcol=10000 , limrow = 10000;

option MIP=CPLEX;

solve BSC1 using MIP minimizing ztotal;

display z1.l,z2.l,z3.l,ztotal.l,wc.l,wb.l,qtest.l,qtrns.l,qinva.l,qinvb.l,qinvc.l,qveh.l,y.l,x.l,e.l,f1.l,f2.l,f3.l,f4.l,f5.l,x.l,y.l,u.l,cbc,f6.l;
