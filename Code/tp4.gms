...
Sets
         ...
         t index of time periods/t1,t2,t3,t4/

         i index of candid nodes for blood banks/i1,i2,i3,i4/

         j index of donation centers/j1,j2,j3/

         k index of blood facilities/k1,k2,k3/

         v index of types of vehicles/v1,v2,v3,v4/
...
Parameters
         ...
         cinv(k) The cost of purchasing and setting up a unit of type ko storage equipment/k1 600,k2 800,k3 500/

         rinv(k,b) The maximum number of blood units of type b that can be stored in equipment ko

         chold(b) The cost of maintaining a unit of type b blood for a period in the blood bank/b1 3,b2 6/

         o(v) Transport capacity of type v vehicle/v1 350,v2 400,v3 280,v4 220/
         ...
         cfix(v) The fixed cost of transporting each unit of blood by vehicle type v/v1 80,v2 30,v3 50,v4 60/
...
d(h,b,t)=uniformint(100,200);

a(j,b,t)=uniformint(150,200);
...
oinv(k,i)=uniformint(10,15);

beta(t,b)=uniform(0.04,0.15);

otest(i,b,t)=uniformint(100,200);

gvup(v,t)=uniformint(10,15);
...
eqzt            ..      ztotal=e=((z1-58729)/58729)+((z2-383)/383)+3*((z3-2988)/2988);
...
display z1.l,z2.l,z3.l,ztotal.l,wc.l,wb.l,qtest.l,qtrns.l,qinva.l,qinvb.l,qinvc.l,qveh.l,y.l,x.l,e.l,f1.l,f2.l,f3.l,f4.l,f5.l,x.l,y.l,u.l,cbc,u.l;
