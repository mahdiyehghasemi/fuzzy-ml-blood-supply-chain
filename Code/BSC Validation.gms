...
Parameters
         ...
         rinv(k,b) The maximum number of blood units of type b that can be stored in equipment ko/k1.b1 280,k1.b2 350,k2.b1 250,k2.b2 300/

         chold(b) The cost of maintaining a unit of type b blood for a period in the blood bank/b1 3,b2 6/

         o(v) Transport capacity of type v vehicle/v1 350,v2 400/
         ...
         gbup The upper limit of the number of blood banks that can be built/4/
...
a(j,b,t)=uniformint(100,250);

ctest(i,b)=uniformint(5,15);

l(i,h)=uniformint(5,15);

cvar(v,b)=uniformint(10,15);

oinv(k,i)=uniformint(5,10);
...
eqzt            ..      ztotal=e=((z1-16353)/16353)+((z2-78)/78)+((z3-200)/200);
