...
Sets
         ...
         h index of hospitals/h1,h2,h3,h4,h5/

         b index of types of blood/b1,b2,b3/

         t index of time periods/t1,t2,t3,t4/

         i index of candid nodes for blood banks/i1,i2,i3,i4,i5,i6,i7/

         j index of donation centers/j1,j2,j3,j4/
...
Parameters
         ...
         cinv(k) The cost of purchasing and setting up a unit of type ko storage equipment/k1 600,k2 800/
         ...
         gbup The upper limit of the number of blood banks that can be built/6/
...
otest(i,b,t)=uniformint(150,200);

gvup(v,t)=uniformint(10,15);

rinv(k,b)=uniform(50,150);
...
eqzt            ..      ztotal=e=((z1-114648)/114648)+((z2-577)/577)+3*((z3-2275)/2275);
