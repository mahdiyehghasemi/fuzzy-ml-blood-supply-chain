...
Parameters
         ...
         rinv(ko,b) The maximum number of blood units of type b that can be stored in equipment ko/k1.b1 280,k1.b2 350,k2.b1 250,k2.b2 300/
...
l(i,ho)=uniformint(5,15);

cvar(v,b)=uniformint(10,15);

oinv(ko,i)=uniformint(5,10);
