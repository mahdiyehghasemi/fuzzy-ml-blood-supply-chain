...
Sets
         ...
         ho index of hospitals/ho1,ho2,ho3,ho4/
         ...
         ko index of blood facilities/ko1,ko2,ko3/
...
Parameters
         ...
         cinv(ko) The cost of purchasing and setting up a unit of type ko storage equipment/ko1 400,ko2 500,ko3 600/
         ...
         o(v) Transport capacity of type v vehicle
...
d(ho,b,t)=uniformint(50,100);

a(j,b,t)=uniformint(100,200);

ctest(i,b)=uniformint(5,8);

l(i,ho)=uniformint(10,15);

cvar(v,b)=uniformint(5,10);

oinv(ko,i)=uniformint(15,25);
